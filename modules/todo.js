class ToDoList {
    ...
    this.todoList = [];
    this.localStorageInstance = 'todos';
  ...
  updateDom = () => {
    ...
    this.todoList.forEach((element) => {
      ...
      ref.taskList.innerHTML = `${ref.taskList.innerHTML} <li class="todo-item">
  ...
  onSaveList = () => {
    if (this.testMode === false) {
      localStorage.setItem(this.localStorageInstance, JSON.stringify(this.todoList));
    }
  ...
  onLoadList = () => {
    if (this.testMode === false) {
      if (localStorage.getItem(this.localStorageInstance) != null) {
        this.todoList = JSON.parse(localStorage.getItem(this.localStorageInstance));
      }
    }
